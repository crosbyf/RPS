...
var round = 1;
var choices = ["Lapis", "Papyrus", "Scalpellus"];
...
function compareChoices() {
  ...
  if (computer.currentChoice === player.currentChoice) {
    showResult("You both chose " + computer.currentChoice + ". Tie! Let's go again.");
    console.log("tie, no score change");
  } else if (computer.currentChoice === choices[0]) {
    if (player.currentChoice === choices[1]) {
      showResult("You chose " + player.currentChoice + " to the computer's " + computer.currentChoice + ". You win! Want to go again?");
      incrementScore("player"); //  score.player = score.player + 1;
    } else {
      showResult("You chose " + player.currentChoice + " to the computer's " + computer.currentChoice + ". The computer wins! Want to go again?");
...
function showResult(result) {
  var roundEl = document.createElement("h2");
  roundEl.innerText = "Round " + round;
  var results = document.createElement("div");
  results.innerText = "Player choice: " + player.currentChoice + "! Computer choice: " + computer.currentChoice + "!";
...
function updateScores() {
  ...
  var computerScoreEl = scoreEl.querySelector(".computer span");
  var playerScoreEl = scoreEl.querySelector(".player span");
  computerScoreEl.innerHTML = score.computer;
  playerScoreEl.innerHTML = score.player;
}

updateScores(); // other stuff I tried...
...
//# sourceMappingURL=/RPS.e31bb0bc.js.map